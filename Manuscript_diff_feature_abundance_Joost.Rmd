...
this throws error "Error: package 'nanny' is not available"
...
same with required bioconductor packages
execute only once
...
# library(magrittr)
# library(tibble)
# library(dplyr) # already loaded via GGally
=======
...
library(purrr)
library(ggrepel)
library(tidyHeatmap) # NOTE: this was not loaded in the README.Rmd
library(pasilla)
library(tidybulk)
...
# # below libraries loaded for README.Rmd
# library(knitr)
# knitr::opts_chunk$set(cache = TRUE, warning = FALSE,
#                       message = FALSE, cache.lazy = FALSE)
# 
...
update: the documentation of adjust_abundance does have reference to combat..
...
the documentation of adjust_abundance is not very clear on this - perhaps also reference to combat should be in there
>>>>>>> master
